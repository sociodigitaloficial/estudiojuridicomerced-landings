...
function gracias() {
    ...
    document.getElementsByClassName('background--call4')[0].setAttribute('style','display:none;')
    document.getElementsByClassName('benefits-title')[0].innerHTML = '<strong class="strong-calypso">GRACIAS</strong> POR QUERER ASESORARTE CON NOSOTROS'
    document.getElementsByClassName('benefits-list')[0].setAttribute('style','display:none;')
    document.getElementsByClassName('benefits-form')[0].setAttribute('style','display:none;')
    document.getElementsByTagName('Body')[0].setAttribute('style','background-color: var(--black);');
